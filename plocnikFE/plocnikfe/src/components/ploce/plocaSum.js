...
class PlocaSum extends Component{
    constructor(props){
        super(props);
        this.state={
            slika:''
        ...
        <div class="col s6 m4 l2 ">
             <Link to={'/vinylPloca/'+ploca.idVinylPloca}>
              <div class="card small grey darken-3" key={ploca.idVinylPloca}>
                ...
                <span class="card-title"> {ploca.nazivVinylPloca} - {ploca.idIzvodac.nazivIzvodac}</span>
                <span className="icon">{ploca.ukOcjena}<i class="material-icons gold"> star</i></span>
                </div>
            </div>
            </Link>
        </div>
